        ...
        <div className="mb-8">
          ...
          <div className="mt-5">
            ...
            <div className="flex items-center justify-between space-x-2">
              ...
              <button onClick={onFavClick} className={cls("p-3 rounded-md flex items-center justify-center", data?.isLiked ? " text-red-400 hover:bg-red-100 hover:text-red-500":" text-gray-400 hover:bg-gray-100 hover:text-gray-500" )}>
               { data?.isLiked ? 
     <svg
     className="w-6 h-6"
     fill="currentColor"
...
/>
        ...
        <div>
          ...
          <div className=" mt-6 grid grid-cols-2 gap-4">
            {data?.relatedProducts?.map((product:any, i) => (
              <div key={product.id}>
