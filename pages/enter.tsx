...
const Enter: NextPage = () => {
  const [enter, { loading, data, error }] = useMutation<MutatiionResult>("/api/users/enter")
  const [confirmToken, { loading:tokenLoading, data:tokenData, error:tokenError }] = useMutation<MutatiionResult>("/api/users/confirm")
  const [submitting, setSubmitting] = useState(false)
  const { watch, register, reset, handleSubmit } = useForm<EnterForm>()
