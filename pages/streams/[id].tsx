...
const Live: NextPage = () => {
  ...
  const onValid = (form: MessageForm) => {
    ...
    mutate(prev => prev && ({
      ...prev, stream: {
        ...prev.stream, Message: [...prev.stream.Message, { id: Date.now(), message: form.message, user: { ...user, } }]
      }
    }) as any, false)
    sendMessage(form)
  }
    ...
    <div className="py-10 px-4  space-y-4">
      ...
      <div>
        ...
        <div className="py-10 pb-16 h-[50vh] overflow-y-scroll  px-4 space-y-4">
          {data?.stream.Message.map((message: StreamWithMessage) =>
